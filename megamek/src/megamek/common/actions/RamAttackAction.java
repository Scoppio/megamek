...
public class RamAttackAction extends AbstractAttackAction {
     ...
     * To-hit number for a ram, assuming that movement has been handled
     */
    public ToHitData toHit(TWGame twGame, Targetable target, Coords src, int elevation, Coords priorSrc,
        ...
        Hex attHex = twGame.getBoard().getHex(src);
    ...
    public ToHitData toHit(TWGame twGame, MovePath md) {
        ...
        return toHit(twGame, target, ramSrc, ramEl, priorSrc, ramStep.getMovementType(true));
    }
