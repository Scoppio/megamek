...
public class KillCountVictory implements VictoryCondition, Serializable {
    ...
    public VictoryResult checkVictory(TWGame twGame, Map<String, Object> ctx) {
        ...
        updateKillTables(twGame, killsPerTeam, killsPerNoTeamPlayer, twGame.getWreckedEntities());
        updateKillTables(twGame, killsPerTeam, killsPerNoTeamPlayer, twGame.getCarcassEntities());
        ...
        if (killCount >= requiredKillCount) {
            ...
            if (teamHasHighestKills) {
                ...
                Player winner = twGame.getPlayer(highestKillsId);
    ...
    private void updateKillTables(IGame IGame,
        ...
        while (victims.hasMoreElements()) {
            ...
            Entity killer = IGame.getEntityFromAllSources(wreck.getKillerId());
